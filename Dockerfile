...
RUN apt-get update -y;\
    apt-get upgrade -y;
RUN apt-get install -y git bc i2c-tools fonts-freefont-ttf whiptail make gcc python3-pil python3-smbus python3-dateutil libfuse-dev systemd dbus-user-session sudo
